...
## Project Structure
    ...
    ├── testapiautosetting_128602  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_128602`
...
2. Clone this repo and `cd testapiautosetting_128602`
